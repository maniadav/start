          ...
          <div className=" mx-auto h-full sm:p-10">
            ...
            <header className="container px-4 lg:flex mt-20 md:mt-10 items-center h-full lg:mt-0">
              <div className="w-full">
                ...
                <a
                  href="https://github.com/maniadav/START/blob/master/survey.md"
                  target="_blank"
                  className="bg-primary text-white text-2xl font-medium px-4 py-2 rounded shadow inline-flex items-center justify-center w-full text-center border border-gray-200 sm:w-auto hover:bg-gray-700 focus:ring-4 focus:ring-gray-100"
                >
                  <svg
