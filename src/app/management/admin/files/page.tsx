...
import { getFiles, getOrganizations, getSurveys, getObservers, formatFileSize } from "@management/lib/data-service"
      ...
      cell: ({ row }) => {
        ...
        return (
          <div>
            ...
            {survey && <div className="text-xs text-muted-foreground mt-1">{survey.name}</div>}
          </div>
        )
      },
    },
      ...
      cell: ({ row }) => {
        ...
        return (
          <div>
            ...
            {observer && <div className="text-xs text-muted-foreground mt-1">{observer.name}</div>}
          </div>
        )
      },
    },
      ...
      cell: ({ row }) => {
        ...
        return (
          <div>
            ...
            {org && <div className="text-xs text-muted-foreground mt-1">{org.name}</div>}
          </div>
        )
      },
    },
      ...
      cell: ({ row }) => {
        ...
        return (
          <div>
            ...
            {user && <div className="text-xs text-muted-foreground mt-1">{user.id}</div>}
          </div>
        )
      },
    },
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center space-x-2">
        <SidebarTrigger />
        <h2 className="text-3xl font-bold tracking-tight">All Uploaded Files</h2>
      </div>
        ...
        <CardHeader>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              <Label htmlFor="survey-filter" className="text-sm">
                Survey:
              </Label>
            ...
            <div className="flex items-center gap-2">
              <Label htmlFor="org-filter" className="text-sm">
                Organisation:
              </Label>
            ...
            <div className="flex items-center gap-2">
              <Label htmlFor="observer-filter" className="text-sm">
                Observer:
              </Label>
