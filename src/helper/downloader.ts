...
export const flattenJson = (data: any, parentKey = '', result: FlatJson = {}): FlatJson => {
...
export const jsonToCsv = (jsonObject: any[]): any => {
  ...
  let blob = new Blob([JSON.stringify(jsonObject)], { type: 'application/json' })
...
export const DowloadFile = (obj: any, filename: string): void => {
