      ...
      <div className="text-gray-300 container mx-auto p-8 overflow-hidden md:rounded-lg md:p-10 lg:p-12">
        ...
        <div className="flex justify-between">
          ...
          <a
            ...
            className="self-start px-3 py-2 leading-none text-gray-200 border border-gray-800 rounded-lg focus:outline-none focus:shadow-outline hover:from-indigo-500 bg-gradient-to-b from-gray-900 to-black"
          >
            Get this template
          </a>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="flex flex-col justify-center md:col-span-2">
            ...
            <div className="grid gap-6 pt-8 border-t border-gray-800 lg:grid-cols-3">
              ...
              <div>
                <p className="font-semibold text-gray-400">Its easy to build</p>
                <div className="h-4"></div>
                <p className="font-serif text-gray-400">
                  Ipsum dolor sit, amet consectetur adipisicing elit. Delectus
                  amet consectetur.
